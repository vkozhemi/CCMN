...
class Calendar(ttk.Frame):
    ...
    def _pressed(self, evt):
        ...
        # -------------------------------------------------------------------------------------------------------------
        if self.todaydate >= self.datetime(self.date.year, self.date.month, int(self._selection[0])):
            self.date = self.datetime(self.date.year, self.date.month, int(self._selection[0]))
    ...
    def _next_month(self):
        ...
        year, month = self.date.year, self.date.month
        self.date = self.date + self.timedelta(
